...
def find_game_price_and_link(name: str, shop: str) -> tuple[float,str] | tuple[None, None]:
    shop_url = {"zaka_zaka": "https://zaka-zaka.com/", "steam_pay": "https://steampay.com/", "gabe_store": "https://gabestore.ru/"}
    price_classes = {"zaka_zaka": "price", "steam_pay": "product__current-price", "gabe_store": "b-card__price-currentprice"}
